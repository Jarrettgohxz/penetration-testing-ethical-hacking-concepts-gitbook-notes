...
* [Server-Side attacks](web-application-penetration-testing/server-side-attacks/README.md)
  ...
  * [File inclusion & Path traversal](web-application-penetration-testing/server-side-attacks/file-inclusion-and-path-traversal.md)
...
* [Client-Side attacks](web-application-penetration-testing/client-side-attacks/README.md)
  * [Insecure deserialization](web-application-penetration-testing/client-side-attacks/insecure-deserialization.md)
  * [Cross-Side Resource Forgery (CSRF)](web-application-penetration-testing/client-side-attacks/cross-side-resource-forgery-csrf.md)
