...
* [Client-Side attacks](web-application-penetration-testing/client-side-attacks/README.md)
  * [CORS vs CSRF](web-application-penetration-testing/client-side-attacks/cors-vs-csrf/README.md)
    * [Cross-Side Resource Forgery (CSRF)](web-application-penetration-testing/client-side-attacks/cors-vs-csrf/cross-side-resource-forgery-csrf.md)
    * [Cross Origin Resource Sharing (CORS)](web-application-penetration-testing/client-side-attacks/cors-vs-csrf/cross-origin-resource-sharing-cors.md)
...
* [TryHackMe](write-ups/tryhackme/README.md)
  ...
  * [Include](write-ups/tryhackme/include/README.md)
    ...
    * [Express app (port 4000)](write-ups/tryhackme/include/express-app-port-4000.md)
    * [Apache web server (port 50000)](write-ups/tryhackme/include/apache-web-server-port-50000.md)
    * [Further learning](write-ups/tryhackme/include/further-learning/README.md)
      ...
      * [Privilege escalation](write-ups/tryhackme/include/further-learning/privilege-escalation.md)
