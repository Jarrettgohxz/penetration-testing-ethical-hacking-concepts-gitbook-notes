...
In this section, we will analyse the basic networking services present on the device

## 1. Automatic IP lease (DHCP)

An ethernet cable will be used to connect the "Ethernet" port of the router and a test machine (eg. Raspberry Pi). We will be using Wireshark to view the live network traffic flowing between the router and test machine.
...
### 2.4 LAN interface scan results
...
### 2.5 WAN interface scan results
...
## 3. Basic network services testing
